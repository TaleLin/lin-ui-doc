...
**务必勾选`将 JS 编译成 ES5 `选项**，[参考图片](https://s1.ax1x.com/2022/04/13/LKdjpV.png)
...
3. 配置微信开发者工具
   要正确安装 Lin UI，需将微信开发者工具的如下**选项勾选上**，[参考图片](https://s1.ax1x.com/2022/04/13/LKdjpV.png)
...
1. 配置微信开发者工具
     ...
     - 要正确使用 Lin UI，需将微信开发者工具的`将 JS 编译成 ES5`选项勾选上
